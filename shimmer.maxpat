...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.5, 630.0, 74.0, 22.0 ],
					"text" : "slide~ 10 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 685.0, 626.0, 74.0, 22.0 ],
					"text" : "slide~ 10 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 685.0, 585.5, 54.0, 22.0 ],
					"text" : "delay~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 268.5, 600.0, 54.0, 22.0 ],
					"text" : "delay~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1027.0, 203.0, 40.0, 22.0 ],
					"text" : "*~ 0.9"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1027.0, 233.5, 285.0, 22.0 ],
					"text" : "limi~ 1 @threshold -1. @release 30 @lookahead 64"
				}
...
, 							{
								"box" : 								{
									...
									"preset_data" : [ 										{
											"number" : 1,
											"data" : [ 5, "obj-9", "toggle", "int", 1, 5, "obj-17", "number", "int", 15, 5, "obj-3", "live.gain~", "float", -2.188976287841797, 5, "obj-32", "number", "int", 28 ]
										}
 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 685.0, 555.0, 78.0, 19.0 ],
					"text" : "pfft~ 1stfft 2048 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 222.0, 568.0, 78.0, 19.0 ],
					"text" : "pfft~ 1stfft 2048 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 149.0, 644.0, 80.0, 13.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 146.5, 620.0, 158.5, 620.0 ],
					"order" : 0,
					"source" : [ "obj-75", 0 ]
				}
